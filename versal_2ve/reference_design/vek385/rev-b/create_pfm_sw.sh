...
gen-machineconf parse-sdt \
	...
	--template $CUR_DIR/sw/yocto/sources/meta-amd-adaptive-socs/meta-amd-adaptive-socs-bsp/conf/machineyaml/versal-2ve-2vm-vek385-revb-sdt-seg.yaml
