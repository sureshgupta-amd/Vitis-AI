...
#define HSC_NR_COMPONENTS           4
		...
		|| (HAS_BGR8==1) || (HAS_R_G_B8==1) || (HAS_Y_U_V8_420==1) || (HAS_RGB_YUV_FP32==1) || (HAS_B_G_R8==1) \
		|| (HAS_BGR_FP32==1) || (HAS_R_G_B_FP32==1) || (HAS_B_G_R_FP32==1) || (HAS_RGBX_YUVX_BF16==1) || (HAS_BGRX_BF16==1) || (HAS_RGB_BF16==1) || (HAS_BGR_BF16==1) || (HAS_R_G_B_BF16==1) || (HAS_B_G_R_BF16==1)\
		|| (HAS_Y_FP16==1) || (HAS_RGB_FP16==1) || (HAS_BGR_FP16==1) || (HAS_RGBX_FP16==1) || (HAS_BGRX_FP16==1) || (HAS_R_G_B_FP16==1) || (HAS_B_G_R_FP16==1))
#define HSC_NR_COMPONENTS           3
#else
#define HSC_NR_COMPONENTS           1
#endif

#if ((HAS_R_G_B8==1) || (HAS_Y_U_V8_420==1) || (HAS_R_G_B_FP32==1) || (HAS_B_G_R_FP32==1) || (HAS_R_G_B_FP16==1) || (HAS_R_G_B_BF16==1) || (HAS_B_G_R_FP16==1) || (HAS_B_G_R_BF16==1) || (HAS_B_G_R8==1))
...
#if (NORMALIZATION == 1)
#if ((HAS_RGB_YUV_FP32==1) || (HAS_BGR_FP32==1) || (HAS_R_G_B_FP32==1) || (HAS_B_G_R_FP32==1) || (HAS_Y_FP32==1) \
		|| (HAS_RGBX_YUVX_BF16==1) || (HAS_Y_BF16==1) || (HAS_BGRX_BF16==1) || (HAS_RGB_BF16==1) || (HAS_BGR_BF16==1) || (HAS_R_G_B_BF16==1) || (HAS_B_G_R_BF16==1) \
		|| (HAS_Y_FP16==1) || (HAS_RGB_FP16==1) || (HAS_BGR_FP16==1) || (HAS_RGBX_FP16==1) || (HAS_BGRX_FP16==1) || (HAS_R_G_B_FP16==1) || (HAS_B_G_R_FP16==1))
...
#if (FLOAT_OUTPUT == 1)
typedef float FLOAT_PIXEL_TYPE;
typedef hls::Scalar<HSC_NR_COMPONENTS * HSC_SAMPLES_PER_CLOCK, FLOAT_PIXEL_TYPE> YUV_FLOAT_MULTI_PIXEL;
#endif //ENABLE_OUTPUT
...
#define RGB_FP32		30  // [95:0] B:G:R 32:32:32
#define BGR_FP32		31  // [95:0] R:G:B 32:32:32
#define R_G_B_FP32		32  // [31:0]R, [31:0]G, [31:0] B
#define YUV_FP32		33  // [95:0] V:U:Y 32:32:32
#define Y_FP32			34  // [31:0] Y 32
#define RGBX_BF16		35  // [63:0] x:B:G:R 16:16:16:16 (Brain Float)
#define Y_BF16			36  // [16:0] Y 16(Brain Float)
#define BGRX_BF16		37  // [63:0] x:R:G:B 16:16:16:16 (Brain Float)
#define RGB_BF16		38	// [47:0] B:G:R 16:16:16 (Brain Float)
#define BGR_BF16		39	// [47:0] R:G:B 16:16:16 (Brain Float)
#define R_G_B8			40  // [7:0] R, [7:0] G, [7:0] B
#define Y_U_V8_420		41  // [15:0] Y:Y 8:8, [7:0] U, [7:0] V
#define Y_FP16			42	// [16:0] Y 16 (FP16)
#define RGB_FP16		43	// [47:0] B:G:R 16:16:16 (FP16)
#define BGR_FP16		44	// [47:0] R:G:B 16:16:16 (FP16)
#define RGBX_FP16		45  // [63:0] x:B:G:R 16:16:16:16 (FP16)
#define BGRX_FP16		46  // [63:0] x:R:G:B 16:16:16:16 (FP16)
#define R_G_B_FP16		47	// [16:0]R, [16:0]G, [16:0]B
#define R_G_B_BF16		48	// [16:0]R, [16:0]G, [16:0]B
#define B_G_R8			49  // [7:0]B, [7:0]G, [7:0]R
#define B_G_R_FP16		50	// [16:0]B, [16:0]G, [16:0]R
#define B_G_R_BF16		51	// [16:0]B, [16:0]G, [16:0]R
#define B_G_R_FP32		52	// [31:0]B, [31:0]G, [31:0]R
...
// Streaming video formats
		...
		2, // UYVY8 // 28
		0, // BGR8 // 29
		7, // RGB_FP32 //30 //float mode
		7, // BGR_FP32 //31 //float mode
		7, // R_G_B_FP32 //32 //float mode
		7, // RGB_FP32 //33 //float mode
		7, // Y_FP32 //34 //float_mode
		7, // RGBX_BF16 //35
		7, // Y_BF16 //36
		7, // BGRX_BF16 //37
		7, // RGB_BF16 //38	//float_mode
		7, // BGR_BF16 //39	//float_mode
		0, // R_G_B8 //40
		3, // Y_U_V8_420 //41
		7,	//Y_FP16	//42	//float_mode
		7,	//RGB_FP16	//43	//float_mode
		7,	//BGR_FP16	//44	//float_mode
		7,	//RGBX_FP16	//45	//float_mode
		7,	//BGRX_FP16	//46	//float_mode
		7,	//R_G_B_FP16	//47	//float_mode
		7,	//R_G_B_BF16	//48	//float_mode
		0,  	//B_G_R8	//49
		7,	//B_G_R_FP16	//50	//float_mode
		7,	//B_G_R_BF16	//51	//float_mode
		7 	// B_G_R_FP32	//52	//float mode
		};
...
#if (FLOAT_OUTPUT == 1)
typedef hls::stream<YUV_FLOAT_MULTI_PIXEL> HSC_STREAM_FLOAT_MULTIPIX;
#endif //FLOAT_OUTPUT
